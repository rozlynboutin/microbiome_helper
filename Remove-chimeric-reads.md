...
You can download the DB used in the above example [here] (https://www.dropbox.com/s/8qr42doaez48oc3/Bacteria_RDP_trainset15_092015.udb?dl=0) (70 MB), which is originally from the Ribosome Database Project (RDP) and then parsed to include only bacteria.
