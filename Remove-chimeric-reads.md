...
You can download the DB used in the above example at [https://github.com/mlangill/microbiome_helper/wiki/Requirements] (https://github.com/mlangill/microbiome_helper/wiki/Requirements).
